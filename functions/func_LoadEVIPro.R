...
#   temp: temperature as character, with suffix C. Example: "0C"
...
load_EVIPro <- function(target_dir,temp,dvmt_file,vmt_bin_width=10) {
  ...
  # correct schedule_Evmt so it isn't greater than schedule_vmt
  evi[schedule_Evmt > schedule_vmt, schedule_Evmt := schedule_vmt]
