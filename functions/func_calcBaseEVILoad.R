...
calcBaseEVILoad <- function(activity_data,time_step,work_load_shift,home_load_shift, desired_time) {
  
  # mutate the load profile data according to the desired load shift strategies for work and home locations
  activity_data <- loadShift(activity_data, work_load_shift, home_load_shift, desired_time)
