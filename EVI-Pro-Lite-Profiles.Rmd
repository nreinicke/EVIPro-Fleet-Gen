...
# Create Names ----------------------------------------------------------------------- 
            load_to_bind[, ':=' (# loc_class = options_list$loc[[1]],
            																					...
            																					home_access = strsplit(getNames(home_power_vec, options_list$home), "_")[[1]][1], # confirm naming convention for this, currently does not fully represent what is happening in permmutation
            																					home_power_dist = strsplit(getNames(home_power_vec, options_list$home), "_")[[1]][2],
            																					work_power_vec = getNames(work_power_vec, options_list$work),
